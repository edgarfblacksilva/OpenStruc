#ifndef TWODFRAMEJOINT
#define TWODFRAMEJOINT

#include "joint.h"

class TwoDFrameJoint: public Joint {
    public:
        TwoDFrameJoint(const string &filename, intPos &, intPos &);
        ~TwoDFrameJoint() {;} // end of TwoDFrameJoint destructor //
