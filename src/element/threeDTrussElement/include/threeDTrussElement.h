#ifndef THREEDTRUSSELEMENT
#define THREEDTRUSSELEMENT

#include "threeDFrameElement.h"

class ThreeDTrussElement : public ThreeDFrameElement 
{
    public:
        ThreeDTrussElement(const string &filename, intPos &DofPerElement, const intPos &siae = 0);
        ~ThreeDTrussElement() {;} // end of ThreeDTrussElement destructor //
...
}; // end of class ThreeDTrussElement //
#endif
