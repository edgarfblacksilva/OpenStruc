...
class GridElement : public  ThreeDFrameElement 
{
    public:
        GridElement(const string &filename, intPos &DofPerElement, const intPos &siae = 0);
        ~GridElement() {;} // end of GridElement destructor //
